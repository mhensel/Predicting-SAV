...
BaeEnvGrow.SEGMENT_2060 = BaeEnvGrow.SEGMENT_2060 %>% 
  mutate(Scen = case_when(Scen == "No Action" ~ "No Further Reductions", 
                          Scen == "Nutrient Reduction" ~ "Nutrient Reduction"))
...
FSimSumSp_Trimmed1 = FSimSumSp_Trimmed %>% filter(Scen %in% c("No Further Reductions", "Nutrient Reduction"))
FSimSumSeg_Trimmed1 = FSimSumSeg_Trimmed %>% filter(Scen %in% c("No Further Reductions", "Nutrient Reduction"))
FSimSum_Trimmed1 = FSimSum_Trimmed %>% filter(Scen %in% c("No Further Reductions", "Nutrient Reduction"))
